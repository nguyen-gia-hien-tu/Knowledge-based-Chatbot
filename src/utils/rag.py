...
@st.cache_resource()
def setup_retriever(
    _index: Index, _embedding: HuggingFaceBgeEmbeddings, folder_path: str
...
@st.cache_resource()
def setup_rag_tools(folder_path: str):
    ...
    # Create a retriever
    retriever = setup_retriever(index, hf_embedding, folder_path)
